      ...
      <div className="card">
        ...
        <div className='text-About'>
            <p>
              ...
              Quarto que a vida é uma só então faça o que você curte e ganhe dinheiro, porque os boletos brotam depois dos 20 anos. Se você for rico desconsidere esse quarto motivo..
            </p>
        </div>
